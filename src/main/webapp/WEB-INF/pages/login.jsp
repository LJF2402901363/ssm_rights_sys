...
<div class="login-box">
    <div class="login-logo">
        <a href="#"><b>后台管理登录页面</b></a>
    </div>
    <!-- /.login-logo -->
    <div class="card">
        <div class="card-body login-card-body">
            <form action="administrator/homePage" method="post" >
                <div class="input-group mb-3">
                    <input type="text" name="name" class="form-control" placeholder="账号/用户名/手机号/邮箱">
            ...
            <div class="social-auth-links text-center mb-3">
                <p>其它登录方式</p>
                <div align="center">
                    <a href="#" class="btn btn-block btn-primary" style="width: 120px;"> QQ登录 </a>
                    <a href="#" class="btn btn-block btn-primary" style="width: 120px;">
                        微信登录</a>
            ...
            <div style="display: flex;width: 100%;">
                ...
                <p class="mb-0" style="margin-left: 190px;">
                    <a href="administrator/toRegister" class="text-center" >注册</a>
                </p>
            </div>
        </div>
        <!-- /.login-card-body -->
